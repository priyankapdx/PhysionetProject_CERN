...
#Data Preprocessing
data = scipy.io.loadmat("augment_normalizedpf")
data=data['augment_normalizedpf']
data=np.array(data)
#print(data.shape)
np.random.shuffle(data)

#print(data.shape)
x_train=(data[0:3000,0:,0:-1])
#print(data[0:20,0:,-1])
...
model.add(LSTM(128, batch_size=1, input_shape=(43,8), activation='tanh', return_sequences=True)) #x_train change to match what you want; paper used tanh activation
